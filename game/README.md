...
nix develop -c godot --headless -s game/items/test_items.gd         # gen-item roll/stats/names, slots, atomic 2H/shield conflict rejection in either equip order, stack rule, gen-loot rates, kill → drop → pick-up → Q
